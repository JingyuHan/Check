...
<div id="wrapper">
	<div id="header">
		...
		<div id="user_info">
			<div id="welcome">欢迎<span style="color:blue">${sessionScope.loginUserName}</span>使用本系统</div>
	...
	<div id="footer">Copyright © 2017 All Rights Reserved Powered By LaoHan</div>
</div>
</body>
