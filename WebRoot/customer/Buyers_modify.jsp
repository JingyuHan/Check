...
<div id="navi">
	<div id='naviDiv'>
		...
		<span><img src="../images/arror.gif" width="7" height="11" border="0" alt=""></span>&nbsp;<a href="<%=path%>/customer/Buyers_query.action">客户列表</a><span>&nbsp;
	</div>
</div>
<div id="tips">
</div>
...
<form name="modifyForm" action="<%=path%>/customer/Buyers_save.action" method="post" onsubmit='if(document.getElementById("address").value==""||document.getElementById("tel").value==""||document.getElementById("name").value==""){alert("请输入相关信息！");return false;}'>
<table width="400" >
	<input type="hidden" name="bid" value='<s:property value="#session.modify_good.bid"/>'/>

  <tr>
    <td width="30%">名称：</td>
    <td><input type="text" name="bname" id="name" value='<s:property value="#session.modify_good.bname"/>'/></td>
  </tr>
  <tr>
    <td  width="30%">联系方式：</td>
       <td><input type="text" name="tel" id="tel" value='<s:property value="#session.modify_good.tel"/>' /></td>
  </tr>
  <tr>
    <td  width="30%">地址：</td>
