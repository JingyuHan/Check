...
<!-- 从session中获取货品集合 -->
<strong>添加厂家资料</strong>
<br>
<br>
<form name="addForm" action="<%=path%>/customer/Sellers_add.action" method="post" onsubmit='if(document.getElementById("tel").value==""||document.getElementById("address").value==""||document.getElementById("name").value=="") {alert("请输入相关数据！");return false;} '>
<table width="400" >
  <tr>
    <td width="30%">名称：</td>
