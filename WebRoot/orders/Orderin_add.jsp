...
<table class="default" width="100%" >
	...
	<tr>
		...
		<form name="addForm" action="<%=path%>/orders/Orderin_add.action" method="post" onsubmit="return check()">
		<td align="center">
	...
	<tr>
				    ...
				    <td>
				    	...
				    	价格：<input id="price" type="text" name="price" onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9-]+/,'');}).call(this)" onblur="this.v();"/>
				   
				    	数量：<input id="amount" name="amount" type="text"onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9-]+/,'');}).call(this)" onblur="this.v();"/>
				    </td>
				    <td colspan="2" align="center">
