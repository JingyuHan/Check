...
<table width="400" >
  <tr>
    <td width="30%">编号：</td>
    <td><input type="text" name="gid" value='<s:property value="#session.modify_good.gid"/>'  readonly="readonly"/></td>
  </tr>
  <tr>
    <td width="30%">名称：</td>
    <td><input type="text" name="gname" id="name" value='<s:property value="#session.modify_good.gname"/>'/></td>
  </tr>
  <tr>
    <td  width="30%">价格：</td>
       <td><input type="text" name="price" id="price" value='<s:property value="#session.modify_good.price"/>' onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9-]+/,'');}).call(this)" onblur="this.v();"/></td>
  </tr>
  <tr>
    <td  width="30%">数量：</td>
